...
const web3 = new Web3(
  new Web3.providers.HttpProvider(
    `https://mainnet.infura.io/v3/8f488c92fb2b4c2b8c0faec8469923fc`
  )
);

async function getERC20Balance(address) {
  // Get the ERC20 token contract ABI
  const abi = [
    // ERC20 contract ABI goes here
  ];
  ...
  // Call the balanceOf function to get the balance of the given address
  const balance = await contract.methods.balanceOf(address).call();

  console.log(`Balance of ${address}: ${balance}`);
  console.log(`Balance of ${address}: ${utils.formatEther(balance)}`);
}

// Replace YOUR_ADDRESS with the address you want to check
